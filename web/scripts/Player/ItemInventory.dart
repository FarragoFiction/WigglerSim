...
class ItemInventory {
    ...
    static AIItem get purpleAradia => new AIItem(0,<ItemAppearance>[new ItemAppearance(PURPLEARADIANAME,"PurpleAradiaDoll.png")], energetic_value: -13, patience_value: -13);
